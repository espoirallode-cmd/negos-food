        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch justify-center gap-12 lg:gap-16 xl:gap-24">
          ...
          <div className="reveal order-1 lg:order-1 text-center lg:text-left flex flex-col items-center lg:items-start lg:max-w-3xl lg:justify-between lg:self-stretch px-4 sm:px-0">
            <div className="flex flex-col items-center lg:items-start">
              ...
              <h2 className="text-3xl sm:text-5xl lg:text-7xl font-semibold text-slate-900 dark:text-foreground leading-[1.2] lg:leading-[1.1] mb-6 flex flex-col items-center lg:items-start text-center">
                <span className="whitespace-nowrap">Passion <span className="italic font-title text-[#0c69e2]">Culinaire</span></span>
